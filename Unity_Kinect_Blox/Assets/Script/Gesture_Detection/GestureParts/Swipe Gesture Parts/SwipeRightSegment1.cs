namespace AssemblyCSharp
{
    ...
    public class SwipeRightSegment1 : IRelativeGestureSegment
    {
		public GesturePartResult CheckGesture(SkeletonWrapper skeleton)
        {
			...
			{
				// Debug.Log("GesturePart 0 - left hand in front of left Shoulder - PASS");
				...
				{
					// Debug.Log("GesturePart 0 - left hand below shoulder height but above hip height - PASS");
                    // //left hand left of left Shoulder
					if (skeleton.bonePos[0, (int)Kinect.NuiSkeletonPositionIndex.HandLeft].x > skeleton.bonePos[0, (int)Kinect.NuiSkeletonPositionIndex.ShoulderLeft].x)
					{
						//Debug.Log("GesturePart 0 - left hand left of left Shoulder - PASS");
                        return GesturePartResult.Suceed;
                    }

					//Debug.Log("GesturePart 0 - left hand left of left Shoulder - UNDETERMINED");
                    return GesturePartResult.Pausing;
                }

				//Debug.Log("GesturePart 0 - left hand below shoulder height but above hip height - FAIL");
                return GesturePartResult.Fail;
            }

			// Debug.Log("GesturePart 0 - left hand in front of left Shoulder - FAIL");
            return GesturePartResult.Fail;
        }
    }
}